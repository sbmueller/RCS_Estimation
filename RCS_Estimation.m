...
v = 100;      % speed of target [m/s] (v>0 -> moves towards receiver)
sigma = 5;  % radar cross section [m^2]

% radar constants

f_a = 200e6; % sampling frequency [Hz]
...
r = [zeros(1, floor(f_a*T - ceil(f_a*(T-tau)))) r]; % fill received vector with nulls for same length
